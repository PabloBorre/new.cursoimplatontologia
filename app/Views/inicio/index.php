<main>
    ...
    <section class="hero">
        <div class="hero-background">
            <img src="/assets/images/hero-bg.webp" alt="" class="hero-bg-image">
        ...
        <div class="hero-content">
            ...
            <div class="hero-logos">
                <img src="/assets/images/logo-pace.png" alt="PACE - Academy of General Dentistry">
                <img src="/assets/images/logo-adi.png" alt="ADI - Association of Dental Implantology">
                <img src="/assets/images/logo-ada-cerp.png" alt="ADA CERP">
            </div>
        </div>
    </section>
        ...
        <div class="stats-container">
            <div class="stat-item">
                <div class="stat-arrows">
                    <img src="/assets/images/flecha-azul-claro.svg" alt="" class="stat-arrow-bg">
        ...
        <div class="team-container">
            <div class="team-content">
                <p class="team-text">
                    ...
                    <span>you will learn from the successes and mistakes of industry leaders to</span> 
                    <strong>start your own path to success</strong> 
                    <span>with the strongest foundation.</span>
                    </p>
